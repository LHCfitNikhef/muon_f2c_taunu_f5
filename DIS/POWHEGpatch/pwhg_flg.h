...
c              by the user. No real diagrams with QCD radiation allowed
     ...
     1     flg_smartsig,flg_bornsmartsig,flg_in_smartsig,flg_bornonly,flg_debug,
     ...
     5     flg_rwl,flg_rwl_add,flg_fullrwgt,flg_noevents,
     6     flg_user_reshists_sep,flg_detailedNLO,
     7     flg_nnlops,flg_minnlo,flg_smartMiNLO,
     8     flg_cachediscardzeroamps,flg_dis,flg_dis_isr,flg_dis_fsr,
     9     flg_polarised_dis
      character * 1 flg_btildepart
      character * 20 flg_processid
      common/pwhg_flg/flg_nlotest,flg_withsubtr,flg_withdamp,
     1     flg_withreg,flg_smartsig,flg_bornsmartsig,flg_in_smartsig,
     ...
     8     flg_fullrwgt,flg_noevents,flg_user_reshists_sep,flg_detailedNLO,
     9     flg_nnlops,flg_minnlo,flg_smartMiNLO,
     1     flg_cachediscardzeroamps,flg_dis,flg_dis_isr,flg_dis_fsr,
     2     flg_polarised_dis,
c strings      
     1     flg_btildepart,flg_processid
      save /pwhg_flg/
